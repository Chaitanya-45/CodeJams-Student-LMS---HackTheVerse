...
if (isset($_POST['submit'])) {
    ...
    // Check if the email already exists in the logindetails table
    $checkEmailQuery = "SELECT * FROM logindetails WHERE Username = '$User'";
    $result = mysqli_query($connLogin, $checkEmailQuery);
